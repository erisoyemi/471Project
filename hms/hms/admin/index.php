                        ...
                        <div class="col-md-3 bg-info mx-2" style="height: 130px;">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="listofdoc.php"><i class="fa-solid fa-user-doctor fa-3x my-4" style="color: white;"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 bg-warning mx-2" style="height: 130px;">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="listofpat.php"><i class="fa-solid fa-hospital-user fa-3x my-4" style="color: white;"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 bg-warning mx-2" style="height: 130px;">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="listofusers.php"><i class="fa-solid fa-hospital-user fa-3x my-4" style="color: white;"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
